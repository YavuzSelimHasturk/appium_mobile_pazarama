...
public class Driver {
    ...
    public static AppiumDriver getAppiumDriver() {
        ...
        if (appiumDriver == null) {
            ...
            caps.setCapability("appPackage","tr.com.topkapidanismanlik.pazarama.app");
            caps.setCapability("appActivity","tr.com.topkapidanismanlik.pazarama.app.ui.SplashActivity");
